...
class TestCases(unittest.TestCase):
    ...
    def test_population_below_poverty_level(self):
        expected = 107711.714
        result = hw3.population_below_poverty_level(reduced_data, "Persons Below Poverty Level")
        self.assertAlmostEqual(expected, result)
    ...
    def test_percent_by_ethnicity(self):
        expected = 0.036007140755062804
        result = hw3.percent_by_ethnicity(reduced_data,'Two or More Races')
        self.assertAlmostEqual(expected, result)

    def test_percent_below_poverty_level(self):
        expected = 0.16424150481920916
        result = hw3.percent_below_poverty_level(reduced_data,'Persons Below Poverty Level')
        self.assertAlmostEqual(expected, result)
    ...
    def test_education_less_than(self):
        expected = [data.CountyDemographics(
            ...
            'Population per Square Mile': 104.4},
            'AR')]
        result = hw3.education_greater_than(reduced_data,"Bachelor's Degree or Higher", .15)
        self.assertEqual(expected,result)
    ...
    def test_below_poverty_level_greater_than(self):
        expected = [data.CountyDemographics(
            ...
            {'2010 Population': 61948,
             ...
             'Population per Square Mile': 104.4},
            'AR')]
        result = hw3.below_poverty_level_greater_than(reduced_data, "Persons Below Poverty Level", .2)
        self.assertEqual(expected, result)
